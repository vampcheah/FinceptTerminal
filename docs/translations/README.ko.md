...
| 📈**실시간 거래**           | Crypto (Kraken/HyperLiquid WebSocket), equity, algo trading, paper trading engine                                                             |
...
| **macOS(애플 실리콘)** | `FinceptTerminal-macOS-arm64.tar.gz`     | Extract → `./FinceptTerminal`                        |
